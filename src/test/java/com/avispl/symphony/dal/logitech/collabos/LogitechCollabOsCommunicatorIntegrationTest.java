...
/**
 * LogitechCollabOsComunicatorIntegrationTest
 *
 * Requires a real device reachable at the configured host - not run as part of the default
 * build.
 *
 ...
 */
@Tag("integrationTest")
public class LogitechCollabOsCommunicatorIntegrationTest {
